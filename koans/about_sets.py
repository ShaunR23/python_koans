...
class AboutSets(Koan):
    ...
    # Sets are a data type used to store a collection of data. Sets are written in curly brackets
    ...
    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        #when empty a set is displayed as () and not {}
    ...
    def test_creating_sets_using_strings(self):
        ...
        #string converted into a set breaking apart each character
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie'}, scotsmen - warriors) #- is for difference, Willie only occurs in scotsmen
        self.assertEqual({'MacLeod', 'Wallace', 'Leonidas' , 'Willie'}, scotsmen | warriors) #| is for union which combines the two sets but sets dont repeat values
        self.assertEqual({'MacLeod', 'Wallace'}, scotsmen & warriors)#& is for intersection, it returns the values the sets have in common
        self.assertEqual( {'Leonidas', 'Willie'} , scotsmen ^ warriors) # ^ is for symmetric difference, returns the values that do not intersect
    ...
    def test_we_can_compare_subsets(self):
        ...
        self.assertEqual(True, set('cake').issubset(set('cherry cake')) ) #cake is a subset of 'cherry cake'
