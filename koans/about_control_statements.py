...
class AboutControlStatements(Koan):
    ...
    def test_if_then_else_statements(self):
        ...
        #never reaches the second result
    def test_if_then_statements(self):
        result = 'default value'
        if True:
            result = 'true value'
        self.assertEqual('true value', result)
        #result is the default value, but is always true so it ends up as "true value"
    ...
    def test_while_statement(self):
        ...
        #i is multiplying with the result of the previous loop 10 times
    ...
    def test_continue_statement(self):
        ...
        #when i does not have a remainder of zero when divided by 2, adds that value to the list
