...
class AboutLists(Koan):
    ...
    def test_slicing_lists(self):
        #slices items in array by index, first number is starting point, second number is ending point
        noms = ['peanut', 'butter', 'and', 'jelly']
    ...
    def test_lists_and_ranges(self):
        #range return a sequence of numbers, starts with 0 by default
        ...
        #first parameter is start value, second is when to stop, third is how much of a step to take
    ...
    def test_insertions(self):
        #insert has 2 parameters, first is the position to insert at and the second is the element
    ...
    def test_popping_lists(self):
        ...
        #pop can take a parameter that specifies which item to remove by index
